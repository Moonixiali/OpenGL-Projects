...
RenderSystem::RenderSystem(unsigned int shader, GLFWwindow* window) {
	...
	VAOs[ObjectType::eRat][AnimationType::eNone].push_back(mesh.VAO);
    VBOs[ObjectType::eRat][AnimationType::eNone].push_back(mesh.VBO);
    vertexCounts[ObjectType::eRat] = mesh.vertexCount;
    textures[ObjectType::eRat] = meshFactory.make_texture("../img/tex_rat.png");
}
